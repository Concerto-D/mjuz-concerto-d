...
const program = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // Create comp
    const novaResource = new sleepingComponent_1.SleepingComponentResource(`${compName}Res${targetDeployment}`, { reconfState: keystoneResWish.offer, timeCreate: 1.0, timeDelete: 3.0, depsOffers: [keystoneResWish.offer] });
