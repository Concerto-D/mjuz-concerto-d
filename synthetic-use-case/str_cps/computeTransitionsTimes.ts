const computeStrCPSCreateTime = (tt_ass: any, assemblyName: string, scalingNum: number): any => {
...
const computeStrCPSDeleteTime = (tt_ass: any, assemblyName: string, scalingNum: number): any => {
	if (assemblyName === "database") {
...
export const computeStrCPSTimes = (transitions_times: any, assemblyName: string, scalingNum: number): any => {
