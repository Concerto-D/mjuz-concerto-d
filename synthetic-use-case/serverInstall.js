...
exports.ServerInstallResource = exports.ServerInstallProvider = void 0;
const pulumi_1 = require("@pulumi/pulumi");
class ServerInstallProvider {
    check(olds, news) {
...
exports.ServerInstallProvider = ServerInstallProvider;
class ServerInstallResource extends pulumi_1.dynamic.Resource {
    constructor(name, props, opts) {
        super(new ServerInstallProvider(), name, props, opts);
    }
}
exports.ServerInstallResource = ServerInstallResource;
